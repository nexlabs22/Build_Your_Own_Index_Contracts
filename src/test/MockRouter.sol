...
contract MockRouter {
    ...
    {
        // return 0;
        uint256 selector = destinationChainSelector;
        ...
        returns (bytes32)
    {
        ...
        (bool success,) = targetAddress.call(abi.encodeWithSelector(this.ccipReceive.selector, finalMessage)); // solhint-disable-line avoid-low-level-calls
    ...
    function ccipReceive(Client.Any2EVMMessage memory message) public {}

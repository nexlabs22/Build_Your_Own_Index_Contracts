...
// import "../../src/factory/BalancerSender.sol";
    ...
    PriceOracleByteCode
{
    ...
    CCIPStorage public indexFactoryStorage;
        ...
        )
    {
        ...
        CCIPStorage indexFactoryStorageImpl = new CCIPStorage();
        indexFactoryStorage = CCIPStorage(
            payable(
                address(
                    new ERC1967Proxy(
    ...
    function deployContracts2()
        public
        returns (CoreSender, CCIPFactory)
    {
        ...
        CCIPFactory indexFactoryImpl = new CCIPFactory();
        CCIPFactory indexFactory = CCIPFactory(
            payable(
                address(
                    new ERC1967Proxy(
